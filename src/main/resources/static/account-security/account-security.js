...
const passwordToggle = document.querySelector("#passwordToggle");
const passwordConfirmInput = document.querySelector("#passwordConfirmInput");
const birthdateInput = document.querySelector("#birthdateInput"); // 추가
const birthdateToggle = document.querySelector("#birthdateToggle"); // 추가
const emailInput = document.querySelector("#emailInput");
const emailToggle = document.querySelector("#emailToggle");
const postalCodeInput = document.querySelector("#postalCodeInput");
const searchAddressButton = document.querySelector("#searchAddressButton");
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (toggle) {
    toggle.addEventListener("change", (e) => {
      toggleField(e, fullNameInput);
    });
  }

  var togglePassword = document.getElementById("passwordToggle");
  if (togglePassword) {
    togglePassword.addEventListener("change", (e) => {
      toggleField(e, passwordInput);
      toggleField(e, passwordConfirmInput);
    });
  }

  var toggleBirthdate = document.getElementById("birthdateToggle");
  if (toggleBirthdate) {
    toggleBirthdate.addEventListener("change", (e) => {
      toggleField(e, birthdateInput);
    });
  }

  var toggleEmail = document.getElementById("emailToggle");
  if (toggleEmail) {
    toggleEmail.addEventListener("change", (e) => {
      toggleField(e, emailInput);
    });
  }
...
//      toggleField(e, searchAddressButton);
  ...
  var togglePhone = document.getElementById("phoneNumberToggle");
  if (togglePhone) {
    togglePhone.addEventListener("change", (e) => {
      toggleField(e, phoneNumberInput);
    });
  }
});
...
function toggleTargets(e) {
  ...
  if (toggleId.includes("birthdate")) { // 추가
    targets = [birthdateInput];
  }
  if (toggleId.includes("email")) {
    targets = [emailInput];
